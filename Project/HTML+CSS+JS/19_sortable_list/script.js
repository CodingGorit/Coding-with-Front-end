/**
 * Created Date: Tuesday, November 7th 2023, 2:57:28 pm
 * Author: CodingGorit
...
//     dragStartIndex = e.target.parentNode.getAttribute('data-index');
...
function swapItems(fromIndex, toIndex) {
    const itemOne = listItem[fromIndex].querySelector('.draggable');
    const itemTwo = listItem[toIndex].querySelector('.draggable');
